...
public class OfferActivity extends AppCompatActivity {
    ...
    private List<LatestOffer> latestOffers;
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(ConfigKey.json_latest_offer_DATA_URL,
...
*/
    ...
    private void parseData(JSONArray array) {
        ...
        for (int i = 0; i < array.length(); i++) {
            LatestOffer course = new LatestOffer();
            JSONObject json = null;
            try {
                json = array.getJSONObject(i);
                course.setOfferId(json.getString(ConfigKey.TAG_offer_ID));
                course.setOfferTittel(json.getString(ConfigKey.TAG_offer_offer_title));
                course.setOfferDescription(json.getString(ConfigKey.TAG_offer_offer_dt));
                course.setOfferBanner(ConfigKey.offer_Image_DATA_URL + json.getString(ConfigKey.TAG_offer_image_file));
        ...
        adapter = new LatestOfferAdapter(latestOffers, this);
    ...
    private void showNotFoundMessage(List latestOffers) {
        ...
        if (latestOffers.size() <= 0) {
            ...
            mTv.setText("We don't have offer now");
            mTv.setVisibility(View.VISIBLE);
        }
