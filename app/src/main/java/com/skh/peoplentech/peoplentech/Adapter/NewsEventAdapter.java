...
public class NewsEventAdapter extends RecyclerView.Adapter<NewsEventAdapter.ViewHolder> {
    ...
    private List<NewsEvent> courseLists;

    public NewsEventAdapter(List<NewsEvent> latestOffers, Activity offerActivity) {
    ...
    public NewsEventAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        NewsEventAdapter.ViewHolder viewHolder = new NewsEventAdapter.ViewHolder(v);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(NewsEventAdapter.ViewHolder holder, int position) {
        ...
        NewsEvent course = courseLists.get(position);


        holder.tittel_tv.setText(course.getNe_name());
        holder.id_tv.setText(course.getNe_id());

        String image_url =course.getNe_img() ;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        NewsEvent Item = courseLists.get(pos);
                     ...
                     //   String[] array = {clickedDataItem.getOfferTittel(), ConfigKey.URL1 + "json_latest_offer_details.php?id=" + clickedDataItem.getOfferId()};
                        String[] array = {"Event Details",Item.getNe_name(),Item.getNe_img(),Item.getNe_details()};
